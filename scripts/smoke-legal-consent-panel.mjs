...
await writeJson(defaultsPath, {
  ...
  minecraftLauncher: { enabled: true, rootDir: minecraftRoot, profileId: 'a-hard-time', profileName: 'A Hard Time', memoryMb: 6144, autoImportAccount: false }
});
...
try {
  ...
  if (!record.affirmed || record.termsVersion !== '2026-07-14.1' || record.privacyVersion !== '2026-09-08.1' || record.termsSha256?.length !== 64 || record.privacySha256?.length !== 64) {
